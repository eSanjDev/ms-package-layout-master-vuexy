...
// Page JS Files
const JsFiles = GetFilesArray('resources/assets/js/*.js');
const PagesJsFiles = GetFilesArray('resources/assets/js/pages/*.js');
...
const PagesScssFiles = GetFilesArray('resources/assets/vendor/scss/pages/!(_)*.scss');
