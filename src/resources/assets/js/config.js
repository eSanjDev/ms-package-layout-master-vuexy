...
window.config = {
  ...
  fontFamily: window.Helpers.getCssVar('font-family-serif'),
...
window.baseUrlAdmin = `${window.baseUrl}admin`;
window.baseUrlApiAdmin = `${window.baseUrl}api/v1/admin`;

if (typeof TemplateCustomizer !== 'undefined') {
  window.templateCustomizer = new TemplateCustomizer({
    displayCustomizer: true,
    lang: localStorage.getItem('templateCustomizer-' + templateName + '--Lang') || 'en', // Set default language here
    defaultPrimaryColor: '#2ABB9C',
    defaultSkin: 0,
    defaultTheme: 'light',
